...
class LoginScreen extends StatefulWidget {
  ...
  LoginScreen({super.key}) {
    if (kDebugMode) {
      // usernameController.text = "ApiDoonamis";
      // passwordController.text = "Z&g64X/m";
      usernameController.text = AppConstants.testEmail;
      passwordController.text = AppConstants.testPassword;
      //usernameController.text = "MUY_Testapp";
      //passwordController.text = "9c+J&6Hr";
      //usernameController.text = "574_Ignasi";
      //passwordController.text = "4r%WE5s=";
    }
  }
