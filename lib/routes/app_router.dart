...
import 'package:social_wallet/views/screens/main/wallet/create_nft_screen.dart';
...
class AppRouter {
    ...
    routes: [
      GoRoute(
        ...
        routes: [
          ...
          GoRoute(name: RouteNames.MainScreenRoute.name, path: Routes.MainScreenRoute, builder: (_, __) => const MainScreen(), routes: [
           GoRoute(
  ...
  static Widget transitionLeftToRight(BuildContext context, Animation<double> animation, Animation<double> secondaryAnimation, Widget child) {
